...
Most of this code is directly taken from the original Clipscore github repository https://github.com/jmhessel/clipscore. However, the code was adjusted to allow a straightforward replication of our main results. For citations and further information on the original Clipscore readme, see below.

# From the original Clipscore README: What's in here?
